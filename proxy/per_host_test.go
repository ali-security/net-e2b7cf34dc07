...
// This is a replacement for slices.Equal.
...
// slicesConcat concatenates multiple slices.
// This is a replacement for slices.Concat.
func slicesConcat[E any](slices ...[]E) []E {
	size := 0
